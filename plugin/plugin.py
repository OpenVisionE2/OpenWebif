...
class OpenWebifConfig(Screen, ConfigListScreen):
	...
	def runSetup(self):
		...
		if config.OpenWebif.enabled.value:
			self.list.append((_("Show CPU benchmark in STB information"), config.OpenWebif.about_benchmarkcpu))
			self.list.append((_("Show RAM benchmark in STB information"), config.OpenWebif.about_benchmarkram))
			self.list.append((_("Show Python benchmark in STB information"), config.OpenWebif.about_benchmarkpython))
